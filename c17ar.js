  ...
  static html = `
    <fieldset>
      ...
      <div>
        <ol>
          <li>
            前提として、場所のリスト（駅名リストなど）を記憶していること
          </li>
          <li>
            記憶したいことを順番に場所に対応づける
          </li>
          <li>
            対応づけた場所と記憶対象を使って、エピソードを作成する
          </li>
          <li>
            1と2によって、道具（カード、ノート、パソコン、スマホ）を何も使わなくても、目をつぶっていても、記憶テスト（アクティブ・リコール）ができる
          </li>
        </ol>
      </div>
    </fieldset>
    <fieldset>
      <legend>場所記憶法</legend>
      <select>
        <option value="総武線" selected>総武線</option>
